...
public enum Locales {
    ...
    NO_GRADIENT_PERMISSION("Messages.NoGradientPermission", "&c✘ &fYou don't have permission to use gradient colors!"),
    MAGIC_BLOCKED("Messages.MagicBlocked", "&c✘ &fYou don't have permission to use magic color!"),
    COLOR_USAGE("Messages.Color.Usage", "&e☀ &fUsage: &e/color <&e&&e#HEXHEX | &e&&e#HEXHEX,#HEXHEX,... | #HEXHEX | &e&&ex | off>"),
    ...
    COLOR_GRADIENT_MIN_TWO("Messages.Color.GradientMinTwo", "&c✘ &fGradient requires at least &c2 &fcolors!"),
